...
my @fractions = `ls derived_data/tp1.fractions.1.txt derived_data/tp1.fractions.2.txt derived_data/tp1.fractions.3.txt derived_data/tp1.fractions.4.txt derived_data/tp1.fractions.5.txt`;
